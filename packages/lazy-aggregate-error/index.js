...
class AggregateErrorExtra extends (0, extend_bases_1.bases)(_aggregate_1.$AggregateError, Array) {
    ...
    set message(message) {
        ...
        if (this[SymbolStackInited]) {
            let meta = this.meta();
            meta.message = String(message !== null && message !== void 0 ? message : '') + '\n' + (0, err_indent_1.indentSubErrors)(this[extend_bases_1.SymbolBases][0].errors, {}, this[extend_bases_1.SymbolBases][0]);
            this[SymbolStackChanged] = true;
        }
    }
    meta(refresh) {
        if (refresh == true || typeof this[SymbolErrStackMeta] === 'undefined') {
            this[SymbolErrStackMeta] = (0, err_stack_meta_1.errStackMeta)(this[extend_bases_1.SymbolBases][0]);
    ...
    get stack() {
        ...
        if (!this[SymbolStackChanged] || this[SymbolStackChanged]) {
            stack = (0, err_stack_meta_1.stringifyStackMeta)({
                ...meta,
                message: (0, err_indent_1.messageWithSubErrors)(this[extend_bases_1.SymbolBases][0]),
            });
